...
#
"""PDSCH DMRS configuration for the nr (5G) sub-package of the Sionna library.
"""
...
class PDSCHDMRSConfig(Config):
    """
    The PDSCHDMRSConfig objects sets parameters related to the generation
    of demodulation reference signals (DMRS) for a physical uplink shared
    channel (PDSCH), as described in Section 6.4.1.1 [3GPP38211]_.
    ...
    Example
    -------
    >>> dmrs_config = PDSCHDMRSConfig(config_type=2)
    >>> dmrs_config.additional_position = 1
    """

    def __init__(self, **kwargs):
        self._name = "PDSCH DMRS Configuration"
    ...
    def type_a_position(self):
        ...
        int, 2 (default) | 3 :  Position of first DMRS OFDM symbol
            ...
            :class:`~sionna.nr.PDSCHConfig.mapping_type` of
            :class:`~sionna.nr.PDSCHConfig` is equal to "A".
        """
    ...
    def additional_position(self):
        ...
        int, 0 (default) | 1 | 2 | 3 : Maximum number of additional DMRS positions
            ...
            the length of the PDSCH symbol allocation.
        """
    ...
    def dmrs_port_set(self):
        ...
        list, [] (default) | [0,...,11] : List of used DMRS antenna ports
            ...
            :class:`~sionna.nr.PDSCHConfig.num_layers` is a property of the
            parent :class:`~sionna.nr.PDSCHConfig` instance.
        """
    ...
    def beta(self):
        r"""
        float, read-only : Ratio of PDSCH energy per resource element
            (EPRE) to DMRS EPRE :math:`\beta^{\text{DMRS}}_\text{PDSCH}`
