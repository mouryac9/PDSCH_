...
"""PDSCH Precoding Layer for the nr (5G) sub-package of the Sionna library."""

import tensorflow as tf
from tensorflow.keras.layers import Layer

class PDSCHPrecoder(Layer):
    # pylint: disable=line-too-long
    r"""
    PDSCHPrecoder(precoding_matrices, dtype=tf.complex64, **kwargs)

    Precodes a batch of modulated symbols mapped onto a resource grid
    for PDSCH transmissions. Each transmitter is assumed to have its
