...
#
"""PDSCH Channel Estimation for the nr (5G) sub-package of the Sionna library.
"""
...
class PDSCHLSChannelEstimator(LSChannelEstimator, Layer):
    ...
    Layer implementing least-squares (LS) channel estimation for NR PDSCH Transmissions.
